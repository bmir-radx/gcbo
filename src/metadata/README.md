 ...
 * [gcbo.yml](gcbo.yml)
     * Determines how your purl.obolibrary.org/obo/gcbo/ redirects will be handled
     ...
     * Paste in the contents of [gcbo.yml](gcbo.yml)
 ...
 * [gcbo.md](gcbo.md)
     ...
     * Paste in the contents of [gcbo.md](gcbo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
